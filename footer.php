<div class="social__footer-mobile">
 <a href="#" class="social__item facebook__footer-soc"><img src="/assets/img/icons/facebook-white.svg"></a>
 <a href="#" class="social__item vk-soc"><img src="/assets/img/icons/vk-white.svg"></a>
 <a href="#" class="social__item insta__footer-soc"><img src="/assets/img/icons/instagram-white.svg"></a>
</div>
<footer> 
 <div class="container">
  <div class="row">
    <div class="col-md-3 col-sm-6 col-lg-3 footer__col-1">
      <div class="footer__logo-block">
        <img src="/assets/img/logo.svg" class="footer__logo">
        <p> cnrg.agency </p>
      </div>
      ...
      <div class="footer__copyright d-lg-block d-none">
        Коммуникационное агентство CNRG<br> Целое. Всегда. Больше.<br> © 2015 - 2021
      </div>
    </div>
      ...
      <div class="map__contacts-item">
        <div class="map__phone">
          ...
          <div class="map__contact-item">
            ...
            <a href="#" class="link"> Перезвоните мне </a>
          </div> 
        </div>
  ...
  <div class="footer__copyright d-lg-none d-block text-sm-center">
    Коммуникационное агентство CNRG Целое. Всегда. Больше. © 2015 - 2021
  </div>
</div>
</div>
</footer>
