		...
		<div class="col">
			...
			<div class="row">
				<? foreach ($arResult["ITEMS"] as $arItem) : ?>
					...
					?>
					<div class="news__item col-lg-4 col-sm-6 col-12" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
						...
						<div class="news__overlay">
							...
							<? if ($arParams["DISPLAY_NAME"] != "N" && $arItem["NAME"]) : ?>
								<div class="news__title">
									<a href="<?= $arItem["DETAIL_PAGE_URL"] ?>"><? if (!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])) : ?>
											<? echo $arItem["NAME"] ?>
										<? else : ?>
											<? echo $arItem["NAME"] ?>
										<? endif; ?></a>
							...
							<? if ($arParams["DISPLAY_PREVIEW_TEXT"] != "N" && $arItem["PREVIEW_TEXT"]) : ?>
								<p class="news__text"><? echo $arItem["PREVIEW_TEXT"]; ?></p>
							<? endif; ?>
