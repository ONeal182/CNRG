...
?>
	...
	<div id="basket-root" class="bx-basket bx-<?= $arParams['TEMPLATE_THEME'] ?> bx-step-opacity" style="opacity: 0;">
		...
		<section class="page__content cart__page mb-5">
			<div class="container">
				<div class="row">
					<div class="minorder__info">
				...
				<div class="row">
					<div class="basket-items">
						<div class="basket-header">
							<div class="basket-header-one">
								<div class="" id="basket-items-list-wrapper">
									<div class="" data-entity="basket-items-list-header">
							...
							<div class="basket-header-two">Цена</div>
							<div class="basket-header-three">Количество</div>
							<div class="basket-header-forth">Сумма</div>
							<div class="basket-header-fivth"> </div>
						</div>
